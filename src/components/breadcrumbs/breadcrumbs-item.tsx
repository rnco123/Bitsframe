...
const BreadcrumbsItem = React.forwardRef<HTMLAnchorElement, React.PropsWithChildren<BreadcrumbsItemProps>>(
  ({ href, nextLink = false, onClick, children, className = '', ...props }: BreadcrumbsItemProps, ref: React.Ref<HTMLAnchorElement>) => {
